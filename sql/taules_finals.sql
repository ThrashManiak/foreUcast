...
BEGIN
	DECLARE TOTAL_COUNTRY INT(10);
       ...
       SELECT AVG(TOTAL) INTO TOTAL_COUNTRY FROM UNIVERSITY WHERE ID_COUNTRY=NEW.ID_COUNTRY GROUP BY ID_COUNTRY;
        ...
        UPDATE EDUCATION SET EDU_COEFICIENT = NEW.TOTAL + PISA WHERE YEAR_DATA=NEW.YEAR_DATA AND ID_COUNTRY=NEW.ID_COUNTRY;
    END 
$$
DELIMITER ;
   ...
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UPC', 3,2002, 'CAT');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UM', 2,2002, 'SPA');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('ANDORRA UNI.', 1,2002, 'AND');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UB', 3,2002, 'CAT');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UPC', 2,2003, 'CAT');
   ...
   ('UM', 1,2003, 'SPA');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('ANDORRA UNI.', 0,2003, 'AND');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UB', 1,2003, 'CAT');
   
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('COLUMBIA', 0.2,2003, 'USA');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('HARVARD', 2.2,2003, 'UK');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UNI. PARIS', 0.2,2003, 'FRA');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('TOKIO UNI.', 1.11,2003, 'JAP');
   
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('COLUMBIA', 0.9,2002, 'USA');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('HARVARD', 2.9,2002, 'UK');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UNI. PARIS', 0.9,2002, 'FRA');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('TOKIO UNI.', 1.9,2002, 'JAP');
   
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UNI. JERUSALEM', 0.2,2003, 'ISR');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('FREE UNI. BERLIN', 2.2,2003, 'GER');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('TECH. MOSCOU', 0.2,2003, 'RUS');
    insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('UNI. JERUSALEM', 0.1,2002, 'ISR');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('FREE UNI. BERLIN', 2.9,2002, 'GER');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('TECH. MOSCOU', 2.2,2002, 'RUS');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('CAMBRIDGE.', 1.11,2003, 'UK');
   insert into UNIVERSITY (UNI_NAME, INDEX1,YEAR_DATA, ID_COUNTRY) VALUES
   ('CAMBRIDGE.', 3,2002, 'UK');
...
--------------------------------------------------------
 COMMENT ON COLUMN 'PROJECT'.'WEALTH'.'WEALTH_COEFICIENT' IS 'Must be greater than zero (enforced by constraint socio_coefi_min)';
  ...
  ALTER TABLE 'PROJECT'.'WEALTH' ADD CONSTRAINT 'WEALTH_COEFI_MIN' CHECK ('WEALTH_COEFICIENT' >= 0);